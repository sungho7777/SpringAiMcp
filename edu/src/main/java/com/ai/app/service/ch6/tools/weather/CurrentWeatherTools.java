...
public class CurrentWeatherTools {
    ...
    @Tool(description = """
            ...
            """)
    WeatherResponse getCurrentWeather(@ToolParam(description = "latitude", required = true) double latitude, @ToolParam(description = "longitude", required = true) double longitude){
